...
class OverpassGeometryTypesTest : AbstractTest() {
    ...
    fun centerXml() {
        ...
        var result = JSONObject(defaultConverter.convertOsmXmlToGeoJson(xml))
        ...
        result = JSONObject(defaultConverter.convertOsmXmlToGeoJson(xml))
    ...
    fun centerJson() {
        ...
        var result = JSONObject(defaultConverter.convertOverpassJsonToGeoJson(json))
        ...
        result = JSONObject(defaultConverter.convertOverpassJsonToGeoJson(json))
