...
class DefaultsTest : AbstractTest() {
    ...
    fun interestingObjects() {
        val json = JSONObject(loadFile("defaults/interesting_objects.json"))
    ...
    fun interestingObjectsRelationMembers() {
        ...
        val result = JSONObject(defaultConverter.convertOsmXmlToGeoJson(xml))
    ...
    fun polygonDetection() {
        var json = JSONObject(loadFile("defaults/polygon_detection_area_yes.json"))
        ...
        json = JSONObject(loadFile("defaults/polygon_detection_area_no.json"))
